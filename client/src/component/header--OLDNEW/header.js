                    ...
                    <div className="container-fluid">
                        ...
                        <nav id='cssmenu' className="navigation">
                            ...
                            <ul className={`nav ${this.state.open ? 'open' : ''}`} style={{ display: this.state.open ? 'block' : '' }}>
                                <li className=""><NavLink to={"/front/home"} activeClassName="active" onClick={this.toggleClass} >Home</NavLink></li>


                                <li className="has-sub">
                                    <span onClick={this.toggleClassSubmenu1} className={`submenu-button ${this.state.openSubmenu1 ? 'submenu-opened' : ''}`}></span>
                                    <NavLink onClick={this.toggleClass} className={this.props.location.pathname == '/front/traditional' || this.props.location.pathname == '/front/set-it-and-leave-it' || this.props.location.pathname == '/front/videos' || this.props.location.pathname == '/front/research' ? 'active' : ''}>Learn</NavLink>
                                ...
                                <li className="has-sub">
                                    ...
                                    <NavLink onClick={this.toggleClass} className={this.props.location.pathname == '/front/tool' || this.props.location.pathname == '/front/faq' ? 'active' : ''}  >Tool</NavLink>
