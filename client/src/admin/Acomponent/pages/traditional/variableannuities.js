...
class VariableAnnuities extends React.Component{
    state={
        title:'',
        content:'',
        data:[],
    ...
    updateContent = e =>{
        ...
        AdminAPI.TraditionalTabUpdate(data)
            .then((res)=>{
                console.log(res)
                if (res.data.success) {
                    this.setState({
...
:
        ...
        AdminAPI.TraditionalTabAdd(data)
            .then((res)=>{
                console.log(res)
            }).catch(err=>{
                console.log(err)
                            ...
                            <div class="row">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading clearfix">
                                        ...
                                        <h5 class="panel-title">Traditional - Variable Annuities</h5>
                                    </div>
