...
class Easytouse extends Component{
    constructor(props){
        ...
        this.AddEasytouseFuc = this.AddEasytouseFuc.bind(this);
...
getEasyToUse() {
    API.getEasytouse()
          .then(res => {
            console.log('name:',res.data.data[2]);
            const contentBlock = htmlToDraft(res.data.data[2].content);
            ...
            this.setState({ 
                ...
                image: res.data.data[2].image,
                id: res.data.data[2]._id,
             });
          }).catch(err => {
  ...
  AddEasytouseFuc(e){
        ...
        API.AddEasyToUse(eicInfoVo).then((result) => {
            this.getEasyToUse()
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading clearfix">
                                                    ...
                                                    <h5 class="panel-title">EASY TO USE</h5>
                                                </div>
                                                ...
                                                <form role="form">
                                                    ...
                                                    <button type="button" onClick={this.AddEasytouseFuc} class="btn btn-success" title="">Submit</button>
                                                </form>
                                                </div>
                                            </div>
                                            </div>
