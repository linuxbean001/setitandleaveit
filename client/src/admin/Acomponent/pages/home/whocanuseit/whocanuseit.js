...
class whoCanUseIt extends Component{
    constructor(props){
        super(props);
        this.state ={
            isHide:false,
        ...
        this.AddWhocanUseitFuc = this.AddWhocanUseitFuc.bind(this);
...
AddWhocanUseitFuc(e){
        ...
        API.AddWhocanuseit(eicInfoVo).then((result) => {
            this.getWhocanuseit()
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading clearfix">
                                                    ...
                                                    <h5 class="panel-title">WHO CAN USE IT</h5>
                                                </div>
                                                ...
                                                <form role="form">
                                                    ...
                                                    <button type="button" onClick={this.AddWhocanUseitFuc} class="btn btn-success" title="">Submit</button>
                                                </form>
                                                </div>
                                            </div>
                                            </div>
