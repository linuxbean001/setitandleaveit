...
class Peaceofmind extends Component{
    constructor(props){
        super(props);
        this.state ={
            isHide:false,
        ...
        this.AddPeaceofmindFuc = this.AddPeaceofmindFuc.bind(this);
...
getPeaceofmind() {
    API.getPeaceOfMind()
          .then(res => {
            console.log('name:',res.data.data[1]);
            const contentBlock = htmlToDraft(res.data.data[1].content);
  ...
  AddPeaceofmindFuc(e){
        ...
        API.AddPeaceofmind(eicInfoVo).then((result) => {
            this.getPeaceofmind()
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading clearfix">
                                                    ...
                                                    <h5 class="panel-title">PEACE OF MIND</h5>
                                                </div>
                                                ...
                                                <form role="form">
                                                    ...
                                                    <button type="button" onClick={this.AddPeaceofmindFuc} class="btn btn-success" title="">Submit</button>
                                                </form>
                                                </div>
                                            </div>
                                            </div>
