...
getAllServiceLists() {
  AdminAPI.getAllServiceList()
        ...
        for(let i=0; i<res.data.data.length; i++){
             RowArray.push({title:res.data.data[i].title,shortcontent:res.data.data[i].shortcontent,action:[<Button onClick={this.EditService.bind(this, res.data.data[i])} variant="success" size="sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></Button>,<Button onClick={this.delService.bind(this, res.data.data[i]._id, i)}  variant="danger" size="sm"><i class="fa fa-trash-o" aria-hidden="true"></i></Button>]}) 
          }
...
AdminAPI.AdminEditServiceInfo(EICInfoVo)
.then((result) => {
    this.getAllServiceLists();
...
delService(id) {
    AdminAPI.AdmindeleteServiceById(id)
      .then(res => {
         this.getAllServiceLists();
    ...
    return(
        <div className="dashboard-section">   
            ...
            <div class="dashboard-content">
              <div className="heading"><h4>Services lists</h4></div>
                        ...
                        >
                           <form >
                            ...
                            <Modal.Body>
                                    ...
                                    <div className="form-group">
                                        <label>Service Short Content</label>
                                    <textarea
                                    className="form-control"
                                    ref="shortcontent"  id="shortcontent" 
                                    name="shortcontent" defaultValue={this.state.EICDetails.shortcontent} 
                                    onChange={this.EIChandleChange.bind(this, "shortcontent")}
                                    />
                                    </div>
