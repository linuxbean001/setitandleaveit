...
class AddFAQ extends Component{
    constructor(props){
        ...
        this.AddFAQFuc = this.AddFAQFuc.bind(this);    
    }
...
AddFAQFuc(e){
        ...
        API.AdminAddFAQ(FAQInfoVo).then((result) => {
                console.log('xxx res:', result );
                this.props.history.replace('/admin/faqlist');
        }).catch(err => {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading clearfix">
                                                    ...
                                                    <h5 class="panel-title">Add FAQ</h5>
                                                </div>
                                                ...
                                                <form role="form">
                                                    ...
                                                    <button type="button" onClick={this.AddFAQFuc} class="btn btn-success" title="">Submit</button>
                                                </form>
                                                </div>
                                            </div>
                                            </div>
