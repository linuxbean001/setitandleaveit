...
confirmBtn() {
  this.delFAQ(this.state.eventIdForDel);
}
...
getAllFAQLists() {
  AdminAPI.getAllFAQList()
        ...
        for(let i=0; i<res.data.data.length; i++){
             RowArray.push({title:res.data.data[i].title,action:[<Button onClick={this.EditFAQ.bind(this, res.data.data[i])} variant="success" size="sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></Button>,<Button onClick={this.openDialogEvent.bind(this, res.data.data[i]._id, i)}  variant="danger" size="sm"><i class="fa fa-trash-o" aria-hidden="true"></i></Button>]}) 
          }
...
AdminAPI.AdminEditFAQInfo(EICInfoVo)
.then((result) => {
    this.getAllFAQLists();
...
delFAQ(id) {
    AdminAPI.AdmindeleteFAQById(id)
      .then(res => {
         this.getAllFAQLists();
          ...
          if (res.data.success) {
              ...
              setTimeout(
                function () {
                    this.setState({ showAlert: false,  eventIdForDel: '' });
                }
                    .bind(this),
                2000
            );
    ...
    return(
        <div className="dashboard-section">   
            ...
            <div class="dashboard-content">
              <div className="heading"><h4>FAQ lists</h4></div>
                  ...
                  <Modal.Header closeButton>
                      <Modal.Title id="contained-modal-title">
                        Confirmation 
                          ...
                          <Modal.Body>
                            <p>Are you sure you wish to delete this FAQ?</p>
                          </Modal.Body>
                          <Modal.Footer>
